...
func (adb *AVLDataBase) GetLastPointsData(ctx context.Context, dataFilter string) ([]*devicepb.AVLData, error) {
	...
	dataConditionmainrelay_StarterRelay := ""
	datadistance := ""
	dataVirtualAccPedal := ""
	...
	if strings.Contains(dataFilter, "speed=") ||
		...
		strings.Contains(dataFilter, "conditioncruisecontrollamp=") ||
		...
		strings.Contains(dataFilter, "Conditionmainrelay_StarterRelay=") ||
		...
		strings.Contains(dataFilter, "Oiltemperature_TCU=") ||
		strings.Contains(dataFilter, "Ambientairtemperature=") ||
		strings.Contains(dataFilter, "NumberofDTC=") ||
		...
		strings.Contains(dataFilter, "FCM_FN_DTC=") ||
		...
		if strings.Contains(dataFilter, "speed=") {
			...
			dataSpeed = " and  speed  >=  " + speed1 + " and   io_elements['speed'] <= " + speed2
		}
		if strings.Contains(dataFilter, "Ignition=") {
			...
			dataIgnition = " and  io_elements['Ignition']  >=  " + Ignition1 + " and   io_elements['Ignition'] <=  " + Ignition2
		...
		if strings.Contains(dataFilter, "GSMSignal=") {
			...
			dataGSMSignal = " and  io_elements['GSMSignal']  >=  " + GSMSignal1 + " and    io_elements['GSMSignal'] <= " + GSMSignal2
		}
		if strings.Contains(dataFilter, "DigitalInput1=") {
			...
			dataDigitalInput1 = " and  io_elements['DigitalInput1']  >=  " + DigitalInput11 + " and    io_elements['DigitalInput1'] <= " + DigitalInput12
		}
		if strings.Contains(dataFilter, "DigitalOutput1=") {
			...
			dataDigitalOutput1 = " and  io_elements['DigitalOutput1']  >=  " + DigitalOutput11 + " and    io_elements['DigitalOutput1'] <= " + DigitalOutput12
		}
		if strings.Contains(dataFilter, "SDStatus=") {
			...
			dataSDStatus = " and  io_elements['SDStatus']  >=  " + SDStatus1 + " and    io_elements['SDStatus'] <= " + SDStatus2
		}
		if strings.Contains(dataFilter, "DigitalInput2=") {
			...
			dataDigitalInput2 = " and  io_elements['DigitalInput2']  >=  " + DigitalInput21 + " and    io_elements['DigitalInput2'] <= " + DigitalInput22
		}
		if strings.Contains(dataFilter, "DigitalOutput2=") {
			...
			dataDigitalOutput2 = " and  io_elements['DigitalOutput2']  >=  " + DigitalOutput21 + " and   io_elements['DigitalOutput2'] <=  " + DigitalOutput22
		}
		if strings.Contains(dataFilter, "CrashDetection=") {
			...
			dataCrashDetection = " and  io_elements['CrashDetection']  >=  " + CrashDetection1 + " and    io_elements['CrashDetection'] <= " + CrashDetection2
		}
		if strings.Contains(dataFilter, "OverSpeeding=") {
			...
			dataOverSpeeding = " and  io_elements['OverSpeeding']  >=  " + OverSpeeding1 + " and    io_elements['OverSpeeding'] <= " + OverSpeeding2
		}
		if strings.Contains(dataFilter, "ExternalVoltage=") {
			...
			dataExternalVoltage = " and  io_elements['ExternalVoltage']  >=  " + ExternalVoltage1 + " and    io_elements['ExternalVoltage'] <= " + ExternalVoltage2
		}
		if strings.Contains(dataFilter, "BatteryVoltage=") {
			...
			dataBatteryVoltage = " and  io_elements['BatteryVoltage']  >=  " + BatteryVoltage1 + " and    io_elements['BatteryVoltage'] <= " + BatteryVoltage2
		}
		if strings.Contains(dataFilter, "AnalogInput1=") {
			...
			dataAnalogInput1 = " and  io_elements['AnalogInput1']  >=  " + AnalogInput11 + " and    io_elements['AnalogInput1'] <= " + AnalogInput12
		}
		if strings.Contains(dataFilter, "AnalogInput2=") {
			...
			dataAnalogInput2 = " and  io_elements['AnalogInput2']  >=  " + AnalogInput21 + " and    io_elements['AnalogInput2'] <= " + AnalogInput22
		}
		if strings.Contains(dataFilter, "AnalogInput3=") {
			...
			dataAnalogInput3 = " and  io_elements['AnalogInput3']  >=  " + AnalogInput31 + " and    io_elements['AnalogInput3'] <= " + AnalogInput32
		}
		if strings.Contains(dataFilter, "AnalogInput4=") {
			...
			dataAnalogInput4 = " and  io_elements['AnalogInput4']  >=  " + AnalogInput41 + " and    io_elements['AnalogInput4'] <= " + AnalogInput42
		}
		if strings.Contains(dataFilter, "PCBTemperature=") {
			...
			dataPCBTemperature = " and  io_elements['PCBTemperature']  >=  " + PCBTemperature1 + " and    io_elements['PCBTemperature'] <= " + PCBTemperature2
		}
		if strings.Contains(dataFilter, "VehicleSpeed=") {
			...
			dataVehicleSpeed = " and  io_elements['VehicleSpeed']  >=  " + VehicleSpeed1 + " and    io_elements['VehicleSpeed'] <= " + VehicleSpeed2
		}
		if strings.Contains(dataFilter, "EngineSpeed_RPM=") {
			...
			dataEngineSpeed_RPM = " and  io_elements['EngineSpeed_RPM']  >=  " + EngineSpeed_RPM1 + " and    io_elements['EngineSpeed_RPM'] <= " + EngineSpeed_RPM2
		}
		if strings.Contains(dataFilter, "EngineCoolantTemperature=") {
			...
			dataEngineCoolantTemperature = " and  io_elements['EngineCoolantTemperature']  >=  " + EngineCoolantTemperature1 + " and    io_elements['EngineCoolantTemperature'] <= " + EngineCoolantTemperature2
		}
		if strings.Contains(dataFilter, "Fuellevelintank=") {
			...
			dataFuellevelintank = " and  io_elements['Fuellevelintank']  >=  " + Fuellevelintank1 + " and    io_elements['Fuellevelintank'] <= " + Fuellevelintank2
		}
		if strings.Contains(dataFilter, "CheckEngine=") {
			...
			dataCheckEngine = " and  io_elements['CheckEngine']  >=  " + CheckEngine1 + " and    io_elements['CheckEngine'] <= " + CheckEngine2
		}
		if strings.Contains(dataFilter, "AirConditionPressureSwitch1=") {
			...
			dataAirConditionPressureSwitch1 = " and  io_elements['AirConditionPressureSwitch1']  >=  " + AirConditionPressureSwitch11 + " and    io_elements['AirConditionPressureSwitch1'] <= " + AirConditionPressureSwitch12
		}
		if strings.Contains(dataFilter, "AirConditionPressureSwitch2=") {
			...
			dataAirConditionPressureSwitch2 = " and  io_elements['AirConditionPressureSwitch2']  >=  " + AirConditionPressureSwitch21 + " and    io_elements['AirConditionPressureSwitch2'] <= " + AirConditionPressureSwitch22
		}
		if strings.Contains(dataFilter, "GearShiftindicator=") {
			...
			dataGearShiftindicator = " and  io_elements['GearShiftindicator']  >=  " + GearShiftindicator1 + " and    io_elements['GearShiftindicator'] <= " + GearShiftindicator2
		}
		if strings.Contains(dataFilter, "DesiredGearValue=") {
			...
			dataDesiredGearValue = " and  io_elements['DesiredGearValue']  >=  " + DesiredGearValue1 + " and    io_elements['DesiredGearValue'] <= " + DesiredGearValue2
		}
		if strings.Contains(dataFilter, "VehicleType=") {
			...
			dataVehicleType = " and  io_elements['VehicleType']  >=  " + VehicleType1 + " and    io_elements['VehicleType'] <= " + VehicleType2
		...
		if strings.Contains(dataFilter, "Conditionimmobilizer=") {
			...
			dataConditionimmobilizer = " and  io_elements['Conditionimmobilizer']  >=  " + Conditionimmobilizer1 + " and    io_elements['Conditionimmobilizer'] <= " + Conditionimmobilizer2
		}
		if strings.Contains(dataFilter, "BrakePedalStatus=") {
			...
			dataBrakePedalStatus = " and  io_elements['BrakePedalStatus']  >=  " + BrakePedalStatus1 + " and    io_elements['BrakePedalStatus'] <= " + BrakePedalStatus2
		}
		if strings.Contains(dataFilter, "ClutchPedalStatus=") {
			...
			dataClutchPedalStatus = " and  io_elements['ClutchPedalStatus']  >=  " + ClutchPedalStatus1 + " and    io_elements['ClutchPedalStatus'] <= " + ClutchPedalStatus2
		}
		if strings.Contains(dataFilter, "GearEngagedStatus=") {
			...
			dataGearEngagedStatus = " and  io_elements['GearEngagedStatus']  >=  " + GearEngagedStatus1 + " and    io_elements['GearEngagedStatus'] <= " + GearEngagedStatus2
		}
		if strings.Contains(dataFilter, "ActualAccPedal=") {
			...
			dataActualAccPedal = " and  io_elements['ActualAccPedal']  >=  " + ActualAccPedal1 + " and    io_elements['ActualAccPedal'] <= " + ActualAccPedal2
		}
		if strings.Contains(dataFilter, "EngineThrottlePosition=") {
			...
			dataEngineThrottlePosition = " and  io_elements['EngineThrottlePosition']  >=  " + EngineThrottlePosition1 + " and    io_elements['EngineThrottlePosition'] <= " + EngineThrottlePosition2
		}
		if strings.Contains(dataFilter, "IndicatedEngineTorque=") {
			...
			dataIndicatedEngineTorque = " and  io_elements['IndicatedEngineTorque']  >=  " + IndicatedEngineTorque1 + " and    io_elements['IndicatedEngineTorque'] <= " + IndicatedEngineTorque2
		}
		if strings.Contains(dataFilter, "EngineFrictionTorque=") {
			...
			dataEngineFrictionTorque = " and  io_elements['EngineFrictionTorque']  >=  " + EngineFrictionTorque1 + " and    io_elements['EngineFrictionTorque'] <= " + EngineFrictionTorque2
		}
		if strings.Contains(dataFilter, "EngineActualTorque=") {
			...
			dataEngineActualTorque = " and  io_elements['EngineActualTorque']  >=  " + EngineActualTorque1 + " and    io_elements['EngineActualTorque'] <= " + EngineActualTorque2
		}
		if strings.Contains(dataFilter, "CruiseControlOn_Off=") {
			...
			dataCruiseControlOn_Off = " and  io_elements['CruiseControlOn_Off']  >=  " + CruiseControlOn_Off1 + " and    io_elements['CruiseControlOn_Off'] <= " + CruiseControlOn_Off2
		}
		if strings.Contains(dataFilter, "SpeedLimiterOn_Off=") {
			...
			dataSpeedLimiterOn_Off = " and  io_elements['SpeedLimiterOn_Off']  >=  " + SpeedLimiterOn_Off1 + " and    io_elements['SpeedLimiterOn_Off'] <= " + SpeedLimiterOn_Off2
		}
		if strings.Contains(dataFilter, "conditioncruisecontrollamp=") {
			conditioncruisecontrollamps := strings.Split(dataFilter, "conditioncruisecontrollamp=")[1]
			...
			dataConditioncruisecontrollamp = " and  io_elements['conditioncruisecontrollamp']  >=  " + conditioncruisecontrollamp1 + " and    io_elements['conditioncruisecontrollamp'] <= " + conditioncruisecontrollamp2
		}
		if strings.Contains(dataFilter, "EngineFuleCutOff=") {
			...
			dataEngineFuleCutOff = " and  io_elements['EngineFuleCutOff']  >=  " + EngineFuleCutOff1 + " and    io_elements['EngineFuleCutOff'] <= " + EngineFuleCutOff2
		}
		if strings.Contains(dataFilter, "Conditioncatalystheatingactivated=") {
			...
			dataConditioncatalystheatingactivated = " and  io_elements['Conditioncatalystheatingactivated']  >=  " + Conditioncatalystheatingactivated1 + " and   io_elements['Conditioncatalystheatingactivated'] <=  " + Conditioncatalystheatingactivated2
		}
		if strings.Contains(dataFilter, "ACcompressorstatus=") {
			...
			dataACcompressorstatus = " and  io_elements['ACcompressorstatus']  >=  " + ACcompressorstatus1 + " and    io_elements['ACcompressorstatus'] <= " + ACcompressorstatus2
		}
		if strings.Contains(dataFilter, "Conditionmainrelay_StarterRelay=") {
			Conditionmainrelay_StarterRelays := strings.Split(dataFilter, "Conditionmainrelay_StarterRelay=")[1]
			Conditionmainrelay_StarterRelay := strings.Split(Conditionmainrelay_StarterRelays, "&")[0]
			Conditionmainrelay_StarterRelay1 := strings.Split(Conditionmainrelay_StarterRelay, "_")[0]
			Conditionmainrelay_StarterRelay2 := strings.Split(Conditionmainrelay_StarterRelay, "_")[1]
			dataConditionmainrelay_StarterRelay = " and  io_elements['Conditionmainrelay_StarterRelay']  >=  " + Conditionmainrelay_StarterRelay1 + " and    io_elements['Conditionmainrelay_StarterRelay'] <= " + Conditionmainrelay_StarterRelay2
		}
		if strings.Contains(dataFilter, "distance=") {
			...
			datadistance = " and  io_elements['distance']  >=  " + distance1 + " and    io_elements['distance'] <= " + distance2
		}
		if strings.Contains(dataFilter, "VirtualAccPeda=") {
			...
			dataVirtualAccPedal = " and  io_elements['VirtualAccPedal']  >=  " + VirtualAccPedal1 + " and    io_elements['VirtualAccPedal'] <= " + VirtualAccPedal2
		}
		if strings.Contains(dataFilter, "Intakeairtemperature=") {
			...
			dataIntakeairtemperature = " and  io_elements['Intakeairtemperature']  >=  " + Intakeairtemperature1 + " and    io_elements['Intakeairtemperature'] <= " + Intakeairtemperature2
		}
		if strings.Contains(dataFilter, "DesiredSpeed=") {
			...
			dataDesiredSpeed = " and  io_elements['DesiredSpeed']  >=  " + DesiredSpeed1 + " and    io_elements['DesiredSpeed'] <= " + DesiredSpeed2
		}
		if strings.Contains(dataFilter, "Oiltemperature_TCU=") {
			Oiltemperature_TCUs := strings.Split(dataFilter, "Oiltemperature_TCU=")[1]
			...
			dataOiltemperature_TCU = " and  io_elements['Oiltemperature_TCU']  >=  " + Oiltemperature_TCU1 + " and   io_elements['Oiltemperature_TCU'] <=  " + Oiltemperature_TCU2
		}
		if strings.Contains(dataFilter, "Ambientairtemperature=") {
			...
			dataAmbientairtemperature = " and  io_elements['Ambientairtemperature']  >=  " + Ambientairtemperature1 + " and io_elements['Ambientairtemperature'] <= " + Ambientairtemperature2
		}
		if strings.Contains(dataFilter, "NumberofDTC=") {
			NumberofDTCs := strings.Split(dataFilter, "NumberofDTC=")[1]
			NumberofDTC := strings.Split(NumberofDTCs, "&")[0]
			NumberofDTC1 := strings.Split(NumberofDTC, "_")[0]
			NumberofDTC2 := strings.Split(NumberofDTC, "_")[1]
			dataNumberofDTC = " and  io_elements['NumberofDTC']  >=  " + NumberofDTC1 + " and io_elements['NumberofDTC'] <= " + NumberofDTC2
		}
		if strings.Contains(dataFilter, "EMS_DTC=") {
			...
			dataEMS_DTC = " and  io_elements['EMS_DTC']  >=  " + EMS_DTC1 + " and    io_elements['EMS_DTC'] <= " + EMS_DTC2
		}
		if strings.Contains(dataFilter, "ABS_DTC=") {
			...
			dataABS_DTC = " and  io_elements['ABS_DTC']  >=  " + ABS_DTC1 + " and    io_elements['ABS_DTC'] <= " + ABS_DTC2
		}
		if strings.Contains(dataFilter, "BCM_DTC=") {
			...
			dataBCM_DTC = " and  io_elements['BCM_DTC']  >=  " + BCM_DTC1 + " and    io_elements['BCM_DTC'] <= " + BCM_DTC2
		}
		if strings.Contains(dataFilter, "ACU_DTC=") {
			...
			dataACU_DTC = " and  io_elements['ACU_DTC']  >=  " + ACU_DTC1 + " and    io_elements['ACU_DTC'] <= " + ACU_DTC2
		}
		if strings.Contains(dataFilter, "ESC_DTC=") {
			...
			dataESC_DTC = " and  io_elements['ESC_DTC']  >=  " + ESC_DTC1 + " and    io_elements['ESC_DTC'] <= " + ESC_DTC2
		}
		if strings.Contains(dataFilter, "ICN_DTC=") {
			...
			dataICN_DTC = " and  io_elements['ICN_DTC']  >=  " + ICN_DTC1 + " and    io_elements['ICN_DTC'] <= " + ICN_DTC2
		}
		if strings.Contains(dataFilter, "EPS_DTC=") {
			...
			dataEPS_DTC = " and  io_elements['EPS_DTC']  >=  " + EPS_DTC1 + " and    io_elements['EPS_DTC'] <= " + EPS_DTC2
		}
		if strings.Contains(dataFilter, "CAS_DTC=") {
			...
			dataCAS_DTC = " and  io_elements['CAS_DTC']  >=  " + CAS_DTC1 + " and    io_elements['CAS_DTC'] <= " + CAS_DTC2
		}
		if strings.Contains(dataFilter, "FCM_FN_DTC=") {
			FCM_FN_DTCs := strings.Split(dataFilter, "FCM_FN_DTC=")[1]
			FCM_FN_DTC := strings.Split(FCM_FN_DTCs, "&")[0]
			FCM_FN_DTC1 := strings.Split(FCM_FN_DTC, "_")[0]
			FCM_FN_DTC2 := strings.Split(FCM_FN_DTC, "_")[1]
			dataFCM_FN_DTC = " and  io_elements['FCM_FN_DTC']  >=  " + FCM_FN_DTC1 + " and    io_elements['FCM_FN_DTC'] <= " + FCM_FN_DTC2
		}
		if strings.Contains(dataFilter, "ICU_DTC=") {
			...
			dataICU_DTC = " and  io_elements['ICU_DTC']  >=  " + ICU_DTC1 + " and   io_elements['ICU_DTC'] <=  " + ICU_DTC2
		}
		if strings.Contains(dataFilter, "Reserve_DTC=") {
			...
			dataReserve_DTC = " and  io_elements['Reserve_DTC']  >=  " + Reserve_DTC1 + " and    io_elements['Reserve_DTC'] <= " + Reserve_DTC2
		}
		if strings.Contains(dataFilter, "Sensor1=") {
			...
			dataSensor1 = " and  io_elements['Sensor1']  >=  " + Sensor11 + " and    io_elements['Sensor1'] <= " + Sensor12
		}
		if strings.Contains(dataFilter, "Sensor2=") {
			...
			dataSensor2 = " and  io_elements['Sensor2']  >=  " + Sensor21 + " and    io_elements['Sensor2'] <= " + Sensor22
		}
		if strings.Contains(dataFilter, "Sensor3=") {
			...
			dataSensor3 = " and  io_elements['Sensor3']  >=  " + Sensor31 + " and    io_elements['Sensor3'] <= " + Sensor32
		}
		if strings.Contains(dataFilter, "Sensor4=") {
			...
			dataSensor4 = " and  io_elements['Sensor4']  >=  " + Sensor41 + " and   io_elements['Sensor4'] <=  " + Sensor42
		}
		if strings.Contains(dataFilter, "Sensor5=") {
			...
			dataSensor5 = " and  io_elements['Sensor5']  >=  " + Sensor51 + " and   io_elements['Sensor5'] <=  " + Sensor52
		}
		if strings.Contains(dataFilter, "Sensor6=") {
			...
			dataSensor6 = " and  io_elements['Sensor6']  >=  " + Sensor61 + " and   io_elements['Sensor6'] <=  " + Sensor62
		}
		if strings.Contains(dataFilter, "Sensor7=") {
			...
			dataSensor7 = " and  io_elements['Sensor7']  >=  " + Sensor71 + " and    io_elements['Sensor7'] <= " + Sensor72
		}
		if strings.Contains(dataFilter, "Sensor8=") {
			...
			dataSensor8 = " and  io_elements['Sensor8']  >=  " + Sensor81 + " and    io_elements['Sensor8'] <= " + Sensor82
		}
		if strings.Contains(dataFilter, "Sensor9=") {
			...
			dataSensor9 = " and  io_elements['Sensor9']  >=  " + Sensor91 + " and    io_elements['Sensor9'] <= " + Sensor92
		}
		if strings.Contains(dataFilter, "Sensor10=") {
			...
			dataSensor10 = " and  io_elements['Sensor10']  >=  " + Sensor101 + " and    io_elements['Sensor10'] <= " + Sensor102
		}
		if strings.Contains(dataFilter, "Sensor11=") {
			...
			dataSensor11 = " and  io_elements['Sensor11']  >=  " + Sensor111 + " and    io_elements['Sensor11'] <= " + Sensor112
		}
		if strings.Contains(dataFilter, "Sensor12=") {
			...
			dataSensor12 = " and  io_elements['Sensor12']  >=  " + Sensor121 + " and   io_elements['Sensor12'] <=  " + Sensor122
		}
		if strings.Contains(dataFilter, "Sensor13=") {
			...
			dataSensor13 = " and  io_elements['Sensor13']  >=  " + Sensor131 + " and   io_elements['Sensor13'] <=  " + Sensor132
		}
		if strings.Contains(dataFilter, "Sensor14=") {
			...
			dataSensor14 = " and  io_elements['Sensor14']  >=  " + Sensor141 + " and    io_elements['Sensor14'] <= " + Sensor142
		}
		if strings.Contains(dataFilter, "Sensor15=") {
			...
			dataSensor15 = " and  io_elements['Sensor15']  >=  " + Sensor151 + " and   io_elements['Sensor15'] <=  " + Sensor152
		}
		if strings.Contains(dataFilter, "Sensor16=") {
			...
			dataSensor16 = " and  io_elements['Sensor16']  >=  " + Sensor161 + " and    io_elements['Sensor16'] <= " + Sensor162
		}
		if strings.Contains(dataFilter, "Sensor17=") {
			...
			dataSensor17 = " and  io_elements['Sensor17']  >=  " + Sensor171 + " and   io_elements['Sensor17'] <=  " + Sensor172
		}
		if strings.Contains(dataFilter, "Sensor18=") {
			...
			dataSensor18 = " and  io_elements['Sensor18']  >=  " + Sensor181 + " and    io_elements['Sensor18'] <= " + Sensor182
		}
		if strings.Contains(dataFilter, "Sensor19=") {
			...
			dataSensor19 = " and  io_elements['Sensor19']  >=  " + Sensor191 + " and    io_elements['Sensor19'] <= " + Sensor192
		}
		if strings.Contains(dataFilter, "Sensor20=") {
			...
			dataSensor20 = " and  io_elements['Sensor20'] >= " + Sensor201 + " and   io_elements['Sensor20'] <= " + Sensor202
		}
	}
	...
	if strings.Contains(dataFilter, "from=") || strings.Contains(dataFilter, "to=") || strings.Contains(dataFilter, "imei=") || strings.Contains(dataFilter, "priority=") || strings.Contains(dataFilter, "eventid=") || strings.Contains(dataFilter, "pg=") || strings.Contains(dataFilter, "limit") {
		...
		if strings.Contains(dataFilter, "eventid=") {
			...
			dataEventId = " and  event_id >= " + eventid1 + " and   event_id<= " + eventid2

		}
		if strings.Contains(dataFilter, "limit") {
			limitData = " limit 5000 OFFSET 1"
		}
		...
		dataFilterQ = " where imei!='0' " + dataFrom + dataTo + dataImei + dataPriority + dataEventId + dataSpeed +
			dataIgnition +
			dataGSMSignal +
			dataDigitalInput1 +
			dataDigitalOutput1 +
